 ...
 */
export const homeSectionMaxWidth = "max-w-[1120px]";

/** Section intro paragraphs (left column under each heading) */
export const sectionIntroText = "text-base leading-7 text-slate-700 sm:text-lg";

/** Body text inside inner cards and tiles */
export const sectionCardText = "text-sm leading-6 text-slate-600 sm:text-base";

/** Body text on dark panels (e.g. About pillars) */
export const sectionDarkBodyText = "text-sm leading-6 text-slate-200 sm:text-base";
...
export const sectionCardSurface =
  "section-card overflow-hidden bg-[#e8edf3] [background-image:var(--section-card-gradient)] border border-[color:var(--section-card-border)]";
export const sectionCardInnerSurface =
  "section-card-inner overflow-hidden bg-[#e3e9f0] [background-image:var(--section-card-inner-gradient)] border border-[color:var(--section-card-inner-border)]";
 ...
 */
export const homeSectionGap = "gap-6";
